...
public class StatixCentralSurfacesImpl extends CentralSurfacesImpl {
    ...
    public StatixCentralSurfacesImpl(
        ...
        super(context, notificationsController, fragmentService, lightBarController, autoHideController,
            ...
            notifShadeEventSource, notificationEntryManager, notificationGutsManager, notificationLogger, notificationInterruptStateProvider,
            ...
            wakefulnessLifecycle, statusBarStateController, bubblesManagerOptional, bubblesOptional, visualStabilityManager,
            ...
            lockscreenGestureLogger, biometricUnlockControllerLazy, dozeServiceHost, powerManager, screenPinningRequest,
            ...
            mainHandler, delayableExecutor, messageRouter, wallpaperManager, startingSurfaceOptional, activityLaunchAnimator,
