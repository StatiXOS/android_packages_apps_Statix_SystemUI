...
public class StatixServices extends VendorServices {
    ...
    private TelephonyManagerListener mTelephonyManagerListener;

    @Inject
    public StatixServices(Context context, AssistManager assistManager, FlashlightController flashlightController, TelephonyManagerListener telephonyManagerListener) {
        super(context);
        mAssistManager = assistManager;
        mFlashlightController = flashlightController;
        mTelephonyManagerListener = telephonyManagerListener;
    }
    ...
    public void start() {
        ...
        if (mContext.getPackageManager().hasSystemFeature("android.hardware.context_hub") && mContext.getPackageManager().hasSystemFeature("android.hardware.sensor.assist")) {
            addService(new ElmyraService(mContext, mAssistManager, mFlashlightController, mTelephonyManagerListener));
        }
    }
