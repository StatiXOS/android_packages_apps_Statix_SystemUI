...
import com.statix.android.systemui.googlebattery.AdaptiveChargingManager;
    ...
    void dispatchIntent(Intent intent) {
        ...
        switch (action) {
            ...
            case "PNW.acChargeNormally":
                ...
                cancelNotification();
                break;
            case "com.statix.android.systemui.adaptivecharging.ADAPTIVE_CHARGING_DEADLINE_SET":
