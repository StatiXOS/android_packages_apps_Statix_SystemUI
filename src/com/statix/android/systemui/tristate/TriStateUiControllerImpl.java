...
public class TriStateUiControllerImpl implements ConfigurationListener, TriStateUiController {
    ...
    public TriStateUiControllerImpl(Context context, VolumeDialogController volumeDialogController, ConfigurationController configurationController) {
        mContext = context;
    ...
    @Override
    public void init(int windowType, TriStateUiController.UserActivityListener listener) {
        initDialog();
        mHandler = new H(this);
