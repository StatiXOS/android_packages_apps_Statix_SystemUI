...
public class KeyguardSliceProviderStatix extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(KeyguardSliceProviderStatix keyguardSliceProviderStatix, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(keyguardSliceProviderStatix);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = keyguardSliceProviderStatix.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            ...
            synchronized (this) {
                ...
                keyguardSliceProviderStatix = this.mProviderReference.get();
            }
