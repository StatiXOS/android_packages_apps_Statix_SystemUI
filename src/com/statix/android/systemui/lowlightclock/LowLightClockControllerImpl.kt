...
class LowLightClockControllerImpl @Inject constructor(
    ...
    override fun attachLowLightClockView(viewGroup: ViewGroup) {
        android.util.Log.d("LowLightClockController", "attachLowLightClockView")
        ...
        lowLightView!!.setOnClickListener {
            view -> powerManager.wakeUp(SystemClock.uptimeMillis(), PowerManager.WAKE_REASON_GESTURE, "com.android.systemui:LOW_LIGHT_GESTURE")
        }
