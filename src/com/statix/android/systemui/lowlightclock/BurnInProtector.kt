...
import com.android.systemui.doze.util.BurnInHelperKt.getBurnInOffset
    ...
    fun updateViewProtection() {
        if (view != null) {
            ...
            val burnInOffsetSubtract = 2 * if (currentTimeMillis < timeUntilFullJitterMillis) {
                Math.round(MathUtils.lerp(0.0f, maxBurnInOffset, (currentTimeMillis as Float ) / (timeUntilFullJitterMillis as Float)));
            } else {
                maxBurnInOffset;
            }
            ...
            view!!.setTranslationX(burnInOffsetX);
            view!!.setTranslationY(burnInOffsetY);
        }
    }
