...
<<<<<<< PATCH SET (3022a8 StatixSystemUI: Finally fix the 1% fill on the flashlight qs)
<<<<<<< PATCH SET (702ffb StatixSystemUI: Finally fix the 1% fill on the flashlight qs)
...
=======
            ...
            shape.draw(tempCanvas);
            canvas.drawBitmap(bitmap, 0, 0, new Paint());
>>>>>>> BASE      (352fbd Remove unused Dependency class)
=======
            // Sometimes, SyetemUI doens't create the bitmap on time which causes
            // the size of the bitmap to be 0 triggering a crash.
            try {
...
>>>>>>> BASE      (0a437b StatixSystemUI: Handle exception when bitmap width and heigh)
        }
