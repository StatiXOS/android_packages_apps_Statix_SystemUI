...
public class SliderQSTileViewImpl extends QSTileViewImpl {
    ...
    private class PercentageDrawable extends Drawable {
        ...
        public void draw(@NonNull Canvas canvas) {
            private int width = Math.round(shape.getBounds().width() * mCurrentPercent);
            private int height = shape.getBounds().height();
            ...
            try {
                ...
                Log.e("SliderQSTileViewImpl", "Invalid width or height for creating Bitmap: width=" + width + ", height=" + height);
            }
