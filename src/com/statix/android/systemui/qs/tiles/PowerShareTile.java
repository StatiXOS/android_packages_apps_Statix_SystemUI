...
public class PowerShareTile extends QSTileImpl<BooleanState>
    ...
    private Lazy<StatusBar> mStatusBarLazy;
    ...
    public void initialize() {
        mAmbientContainer = (AmbientIndicationContainer) mStatusBarLazy.get().getNotificationShadeWindowView().findViewById(R.id.ambient_indication_container);
    }
