...
public class PageIndicator extends LinearLayout {
    ...
    public void setNumPages(int numPages, boolean fromEnd) {
        if (numPages <= 0) {
            Log.w("PageIndicator", "Total number of pages invalid: " + numPages + ". Assuming 1 page.");
            numPages = 1;
        }
        ...
        if (numPages != mNumPages) {
            ...
            for (int i = 0; i < numPages; i++) {
                ...
                if (i >= getChildCount()) {
                    dot.setImageDrawable(getContext().getDrawable(R.drawable.page_indicator_dot).mutate());
            ...
            setContentDescription(getContext().getString(R.string.accessibility_smartspace_page, 1, numPages));
        }
    }
    ...
    public void setPageOffset(float offset, int position) {
        ...
        setContentDescription(getContext().getString(R.string.accessibility_smartspace_page, displayPosition, mNumPages));
    }
}
