...
public class DoubleShadowIconDrawable extends Drawable {
    ...
    public DoubleShadowIconDrawable(Context context) {
        this(context.getResources().getDimensionPixelSize(R.dimen.enhanced_smartspace_icon_size),
    ...
    public void setIcon(Drawable drawable) {
        ...
        if (mIconDrawable != null) {
            ...
            RenderEffect ambientShadowEffect = RenderEffect.createColorFilterEffect(
                    new PorterDuffColorFilter(Color.argb(48, 0, 0, 0), PorterDuff.Mode.MULTIPLY),
                    RenderEffect.createOffsetEffect(
                            0f, 0f,
                            RenderEffect.createBlurEffect(mAmbientShadowRadius, mAmbientShadowRadius, Shader.TileMode.CLAMP)
                    )
            );

            RenderEffect keyShadowEffect = RenderEffect.createColorFilterEffect(
                    new PorterDuffColorFilter(Color.argb(72, 0, 0, 0), PorterDuff.Mode.MULTIPLY),
                    RenderEffect.createOffsetEffect(
                            mKeyShadowOffsetX, mKeyShadowOffsetY,
                            RenderEffect.createBlurEffect(mKeyShadowRadius, mKeyShadowRadius, Shader.TileMode.CLAMP)
                    )
            );
