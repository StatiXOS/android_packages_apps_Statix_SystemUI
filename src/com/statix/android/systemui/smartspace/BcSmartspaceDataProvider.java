...
import com.google.android.systemui.smartspace.DefaultBcSmartspaceConfigProvider;
...
public final class BcSmartspaceDataProvider implements BcSmartspaceDataPlugin {
    ...
    public final View.OnAttachStateChangeListener mStateChangeListener = new StateChangeListener(this);
    ...
    public static class StateChangeListener implements View.OnAttachStateChangeListener {
        ...
        public void onViewAttachedToWindow(View view) {
            ...
            Iterator<View.OnAttachStateChangeListener> iterator = this$0.mAttachListeners.iterator();
            while (iterator.hasNext()) {
