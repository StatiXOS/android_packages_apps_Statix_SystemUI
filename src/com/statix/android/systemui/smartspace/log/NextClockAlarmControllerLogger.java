...
public final class NextClockAlarmControllerLogger {
    ...
    public String processUserSwitchMessage(LogMessage message, int newUser, Integer oldUser, int classId) {
        switch (classId) {
            case 0:
                String userContext = message.getStr3();
                return "onUserChanged newUser=" + newUser + ", oldUser=" + oldUser + ", userContext=" + userContext;
            default:
