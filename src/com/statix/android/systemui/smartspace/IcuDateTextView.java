...
public class IcuDateTextView extends DoubleShadowTextView {
            ...
            if (mBgHandler == null) {
                ...
                mBgHandler.post(() -> {
                    try {
                        ...
                        Log.w("IcuDateTextView", "Receiver not registered: " + e.getMessage());
                    }
                });
            }
    ...
    public void rescheduleTicker() {
        ...
        mHandler.post(() -> { //STX edit
        mTimeChangedDelegate.unregister();
        if (!(mIsInteractive || (mUpdatesOnAod && mIsAodEnabled)) || !isAggregatedVisible()) {
            return;
        }
    ...
    public class IcuDateTextViewReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            boolean updateFormatter = "android.intent.action.TIMEZONE_CHANGED".equals(action) || "android.intent.action.TIME_SET".equals(action);
            outer.onTimeChanged(updateFormatter);
        }
    }

    public class DefaultTimeChangedDelegate implements BcSmartspaceDataPlugin.TimeChangedDelegate, Runnable {
        public Handler mHandler;
