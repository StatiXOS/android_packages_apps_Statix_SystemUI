...
public final class BcSmartspaceCardLoggingInfo {
    ...
    public static final class Builder {
        ...
        public Builder setDimensionalInfo(SmartspaceProto.SmartspaceCardDimensionalInfo dimensionalInfo) {
    ...
    public String toString() {
        ...
        sb.append("instance_id = ").append(mInstanceId)
          .append(", feature type = ").append(mFeatureType)
          .append(", display surface = ").append(mDisplaySurface)
          .append(", rank = ").append(mRank)
          .append(", cardinality = ").append(mCardinality)
          .append(", receivedLatencyMillis = ").append(mReceivedLatency)
          .append(", uid = ").append(mUid)
          .append(", subcardInfo = ").append(mSubcardInfo)
          .append(", dimensionalInfo = ").append(mDimensionalInfo);
        return sb.toString();
    }
}
