...
public abstract class BcSmartspaceCardLoggerUtil {
    ...
    public static SmartspaceProto.SmartspaceCardDimensionalInfo createDimensionalLoggingInfo(BaseTemplateData data) {
        ...
        info.featureDimensions = dimensions.toArray(new SmartspaceProto.SmartspaceFeatureDimension[0]);
        return info;
    }
    ...
    public static BcSmartspaceSubcardLoggingInfo createSubcardLoggingInfo(SmartspaceTarget target) {
        ...
        BcSmartspaceCardMetadataLoggingInfo metadata = new BcSmartspaceCardMetadataLoggingInfo(builder);
    ...
    public static void createSubcardLoggingInfoHelper(List<BcSmartspaceCardMetadataLoggingInfo> subcards,
    ...
    public static void tryForcePrimaryFeatureTypeAndInjectWeatherSubcard(BcSmartspaceCardLoggingInfo loggingInfo,
    ...
    public static void tryForcePrimaryFeatureTypeOrUpdateLogInfoFromTemplateData(
        ...
        if (loggingInfo.mFeatureType == 1) {
            ...
            BaseTemplateData.SubItemLoggingInfo subItemLoggingInfo = data.getPrimaryItem().getLoggingInfo();
