...
public class BaseTemplateCard extends ConstraintLayout implements SmartspaceCard {
    ...
    public void bindData(SmartspaceTarget target, BcSmartspaceDataPlugin.SmartspaceEventNotifier eventNotifier, BcSmartspaceCardLoggingInfo loggingInfo, boolean shouldShowPageIndicator) {
        ...
        if (mSecondaryCard != null) {
            ...
            //STX comment-out BcSmartspaceTemplateDataUtils.updateVisibility(mSecondaryCardPane, mValidSecondaryCard ? View.VISIBLE : View.GONE);
        //STX comment-out } else {
            //STX comment-out Log.i("SsBaseTemplateCard", "Secondary card is null");
            //STX comment-out BcSmartspaceTemplateDataUtils.updateVisibility(mSecondaryCardPane, View.GONE);
        }
