...
public final class BcSmartSpaceUtil {
    ...
    public static void setOnClickListener(View view, SmartspaceTarget smartspaceTarget, SmartspaceAction smartspaceAction, String str, BcSmartspaceDataPlugin.SmartspaceEventNotifier smartspaceEventNotifier, BcSmartspaceCardLoggingInfo bcSmartspaceCardLoggingInfo, int i) {
        setOnClickListener(view, smartspaceTarget, smartspaceAction, null, str, smartspaceEventNotifier, bcSmartspaceCardLoggingInfo, i);
    }

    public static void setOnClickListener(View view, final SmartspaceTarget smartspaceTarget, final SmartspaceAction smartspaceAction, final View.OnClickListener onClickListener, final String str, final BcSmartspaceDataPlugin.SmartspaceEventNotifier smartspaceEventNotifier, final BcSmartspaceCardLoggingInfo bcSmartspaceCardLoggingInfo, final int i) {
        ...
        final BcSmartspaceDataPlugin.IntentStarter intentStarter = sIntentStarter == null ? defaultIntentStarter(str) : sIntentStarter;
    ...
    public static String getDimensionRatio(Bundle bundle) {
        if (bundle != null && bundle.containsKey("imageRatioWidth") && bundle.containsKey("imageRatioHeight")) {
